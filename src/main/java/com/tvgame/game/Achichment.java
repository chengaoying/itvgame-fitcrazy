...
public class Achichment implements UiObject {
	...
	public void draw(Graphics g) {
		...
		for(int i=0;i<4;i++){
			...
			Image achi = Resources.getImage(Integer.parseInt(Const.achi_info[pageIndex*4+i][0][3]));
			...
			String achi_name = Const.achi_info[pageIndex*4+i][0][0];
			String achi_desc = Const.achi_info[pageIndex*4+i][0][4];
