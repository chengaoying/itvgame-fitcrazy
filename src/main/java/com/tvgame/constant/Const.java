...
public class Const {
	...
	public static final String help_str = "每次将屏幕右上角刷新出来的物品放到地图里的格子中，有3个包括3个以上的的相同级别的物品连在一起即可引发合体，合体后就会变成更高一级的物品。\n游戏中，每一株草，每一棵灌木，每一只恐龙都哭着喊求合体。你要学会用各种道具来建造你的村落，建造完成后，你将获得一笔丰厚的奖励。加油吧！\n游戏中按下数字键[7]查看帮助。";//每次将屏幕右上角刷新出来的物品放到地图里的格子中，有3个包括3个以上的的相同级别的物品连在一起即可引发合体，合体后就会变成更高一级的物品。游戏中，你还可以使用炸弹炸毁当前你不想要的物品，也可以使用魔法珠来交换当前地图上的多个物品的位置。可爱的小恐龙常常喜欢在地图上漫步来干扰你，另外飞天猪会在某个阶段出现在游戏地图里，记得你只能用火把才能烧死他们。\n游戏中按下数字键9可以随时进入游戏商城。
