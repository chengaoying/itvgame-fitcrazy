...
public class Const {
	...
	public static String achi_info[][][] = {
		...
		},
		{
			...
			{"合成树木", "300", "4", "2", "个达到银牌成就","，奖励1个小房子"},
			{"合成树木", "800", "5", "2", "个达到金牌成就","，奖励1个树木+1个小房子"},
		},
		{
			/*0-成就名称, 1-成就条件, 2-奖品id, 3-成就id, 4-描述*/
			{"合成小房子", "25", "6", "3", /*"还需200"*/"个达到铜牌成就","，奖励1个小房子"},
			{"合成小房子", "250", "7", "3", "个达到银牌成就","，奖励1个炸弹"},
			{"合成小房子", "500", "8", "3", "个达到金牌成就","，奖励1个小房子+1个炸弹"},
		},
		{
			/*0-成就名称, 1-成就条件, 2-奖品id, 3-成就id, 4-描述*/
